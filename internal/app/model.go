...
func fetchEditSuggestion(ctx context.Context, client *llm.Client, body, fileSystemMessage string, history []editHistoryEntry, overrides prompts.Overrides) editSuggestionResult {
